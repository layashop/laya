...
const icons = {
    ...
    star: (<svg enableBackground="new 0 0 512 512" width="30px" fill="currentColor" version="1.1" viewBox="0 0 512 512"
                xmlns="http://www.w3.org/2000/svg">
		<polygon
            points="512 197.82 325.96 185.58 255.9 9.569 185.84 185.58 0 197.82 142.53 318.84 95.762 502.43 255.9 401.21 416.04 502.43 369.26 318.84"/>
</svg>),
    circle: (
