...
class Business(models.Model):
    ...
    description = models.CharField(
        _("Descripcion"), max_length=200, null=True, blank=True
    )
    ...
    profile_image = models.ImageField(
        ...
        null=True,
        blank=True,
        help_text="Recomendamos que la imagen sea de relacion de aspecto 1:1",
    )
    ...
    class Meta:
        db_table = "bussiness"
        indexes = [HashIndex(fields=["slug"]), BTreeIndex(fields=["name"])]
